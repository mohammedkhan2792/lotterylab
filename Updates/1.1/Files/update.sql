...
ALTER TABLE `gateways` MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
ALTER TABLE `gateway_currencies` ADD PRIMARY KEY (`id`);
ALTER TABLE `gateway_currencies` MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
...
ALTER TABLE `withdraw_methods` ADD PRIMARY KEY (`id`);
ALTER TABLE `withdraw_methods` MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;

ALTER TABLE `general_settings` ADD `request_for_coin` TINYINT(1) NOT NULL DEFAULT '1' AFTER `welcome_bonus`;
