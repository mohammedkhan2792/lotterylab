            ...
            <form action="" method="post">
                ...
                <div class="card-body">
                    <ul class="list-group">
                        ...
                        <li class="list-group-item d-flex flex-wrap flex-sm-nowrap gap-2 justify-content-between align-items-center">
                            <div>
                                <p class="fw-bold mb-0">{{coinName()}} @lang('Request')</p>
                                <p class="mb-0">
                                    <small>@lang('If you enable this module, users can request to platform for ') {{coinName()}}</small>
                                </p>
                            </div>
                            <div class="form-group">
                                <input type="checkbox" data-width="100%" data-size="large" data-onstyle="-success" data-offstyle="-danger" data-bs-toggle="toggle" data-height="35" data-on="@lang('Enable')" data-off="@lang('Disable')" name="request_for_coin" @if($general->request_for_coin) checked @endif>
                            </div>
                        </li>
